...
template sudoku() {
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            var idx = i * 9 + j;
            rangeProof[0][idx] = RangeProof(32);
            rangeProof[0][idx].in <== puzzle[i][j];
            rangeProof[0][idx].range[0] <== 0;
            rangeProof[0][idx].range[1] <== 9;
            rangeProof[0][idx].out === 1;
            ...
            var solutionIdx = i * 9 + j;
            rangeProof[1][idx] = RangeProof(32);
            rangeProof[1][idx].in <== solution[i][j];
            rangeProof[1][idx].range[0] <== 0;
            rangeProof[1][idx].range[1] <== 9;
            rangeProof[1][idx].out === 1;
